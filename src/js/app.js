...
document.addEventListener('DOMContentLoaded', () => {
  ...
  fileInput.addEventListener('change', () => {
    ...
    [...previewItem].forEach((item) => {
      if (item === previewText && previewText.textContent) previewText.textContent = '';
      if (item === previewHTML && previewHTML.firstElementChild) previewHTML.innerHTML = '';
      if (item === previewImage && previewImage.src) previewImage.removeAttribute('src');
    });
